...
public class TechnologyAddictionShowVideos extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technology_addiction_show_videos);

        relativeLayout=(RelativeLayout)findViewById(R.id.tech_add_show_videos_layout);
    ...
    public void setRecommendedVideos(){
        ...
        ArrayAdapter adapter= new ArrayAdapter<>(TechnologyAddictionShowVideos.this,R.layout.tech_addiction_recommended_videos_grid,secilenBasliklar);
    ...
    public void recommendedVideoStarter(int position){
        Intent intent = new Intent( TechnologyAddictionShowVideos.this,TechnologyAddictionShowVideos.class);
    ...
    public void videoArrangements(){
        ...
        youTubePlayerView.initialize(new AbstractYouTubePlayerListener() {
            ...
            public void onReady(@NonNull YouTubePlayer youTubePlayer) {
                TechnologyAddictionShowVideos.this.youTubePlayer = youTubePlayer;
        ...
        youTubePlayerView.addFullscreenListener(new FullscreenListener() {
            ...
            public void onEnterFullscreen(@NonNull View fullscreenview, @NonNull Function0<Unit> exitFullscreen) {
                ...
                GeneralAddictionShowVideos.ViewUtils.rotateAndScaleView(fullscreenViewContainer,TechnologyAddictionShowVideos.this);
            }
            @Override
    ...
    public void backToVideoList(){
        ...
        backIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(TechnologyAddictionShowVideos.this,TechnologyAddictionVideosPage.class);
                startActivity(intent);
                finish();
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (itemId){
                    case R.id.home_tab:
                        ...
                        Intent intent= new Intent(TechnologyAddictionShowVideos.this,TechnologyAddictionMainPage.class);
                        startActivity(intent);
                        break;
                    case R.id.questions_tab:
                        System.out.println("questions");
                        Intent intent2= new Intent(TechnologyAddictionShowVideos.this,TechnologyAddictionQuestionsPage.class);
                        startActivity(intent2);
                        break;
                    case R.id.videos_tab:
                        System.out.println("videos");
                        Intent intent3= new Intent(TechnologyAddictionShowVideos.this, TechnologyAddictionVideosPage.class);
                        startActivity(intent3);
                        break;
                    case R.id.support_tab:
                        System.out.println("support");
                        Intent intent4= new Intent(TechnologyAddictionShowVideos.this,TechnologyAddictionSupportPage.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.kullanici_profili_option:
                        Intent intent= new Intent(TechnologyAddictionShowVideos.this,user_profile.class);
                        startActivity(intent);
                        break;
                    case R.id.neyi_amacliyoruz_option:
                        Intent intent1= new Intent(TechnologyAddictionShowVideos.this, Purpose.class);
                        startActivity(intent1);
                        break;
                    case R.id.geri_bildirim_option:
                        Intent intent3 = new Intent(TechnologyAddictionShowVideos.this, Feedback.class);
                        startActivity(intent3);
                        break;
    ...
    public void logout(){
        auth.signOut();
        Intent intent= new Intent(TechnologyAddictionShowVideos.this, LoginPage.class);
        startActivity(intent);
        finish();
    }
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent = new Intent(this, TechnologyAddictionVideosPage.class);
