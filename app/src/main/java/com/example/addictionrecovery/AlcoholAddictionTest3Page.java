...
public class AlcoholAddictionTest3Page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alcohol_addiction_test1_page);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedRadioButtonId == -1) {
                    Toast.makeText(AlcoholAddictionTest3Page.this, "Lütfen seçim yapınız", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void addQuestions(){
        ...
        String question1 = getResources().getString(R.string.test3_question1);
        String[] options1 = getResources().getStringArray(R.array.test3_options1);
        questionList.add(new QuizModel(question1, options1[0], options1[1], options1[2], options1[3]));

        String question2 = getResources().getString(R.string.test3_question2);
        String[] options2 = getResources().getStringArray(R.array.test3_options2);
        questionList.add(new QuizModel(question2, options2[0], options2[1], options2[2], options2[3]));

        String question3 = getResources().getString(R.string.test3_question3);
        String[] options3 = getResources().getStringArray(R.array.test3_options3);
        questionList.add(new QuizModel(question3, options3[0], options3[1], options3[2], options3[3]));

        String question4 = getResources().getString(R.string.test3_question4);
        String[] options4 = getResources().getStringArray(R.array.test3_options4);
        questionList.add(new QuizModel(question4, options4[0], options4[1], options4[2], options4[3]));

        String question5 = getResources().getString(R.string.test3_question5);
        String[] options5 = getResources().getStringArray(R.array.test3_options5);
        questionList.add(new QuizModel(question5, options5[0], options5[1], options5[2], options5[3]));

        String question6 = getResources().getString(R.string.test3_question6);
        String[] options6 = getResources().getStringArray(R.array.test3_options6);
            ...
            builder.setPositiveButton("Önerilen Videoyu İzle", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (score>12 && score <=18){
                        setFinalVideo(videoTitles,videoIds,videoDescriptions,11,AlcoholAddictionTest3Page.this,AlcoholAddictionShowVideos.class);
                    }
                    else if (score>6 && score <=12){
                        setFinalVideo(videoTitles,videoIds,videoDescriptions,8,AlcoholAddictionTest3Page.this,AlcoholAddictionShowVideos.class);
                    }
                    else {
                        setFinalVideo(videoTitles,videoIds,videoDescriptions,7,AlcoholAddictionTest3Page.this,AlcoholAddictionShowVideos.class);
                    }
                }
            });
    ...
    public void backButtonActivity(){
        ...
        onBackPressedDispatcher.addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(AlcoholAddictionTest3Page.this, AlcoholAddictionMainPage.class);
    ...
    public void logout(){
        ...
        Intent intent = new Intent(AlcoholAddictionTest3Page.this, LoginPage.class);
        startActivity(intent);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.kullanici_profili_option:
                        Intent intent= new Intent(AlcoholAddictionTest3Page.this,user_profile.class);
                        startActivity(intent);
                        break;

                    case R.id.neyi_amacliyoruz_option:
                        Intent intent1=new Intent (AlcoholAddictionTest3Page.this, Purpose.class);
                        startActivity(intent1);
                        break;
                    case R.id.geri_bildirim_option:
                        Intent intent3 = new Intent(AlcoholAddictionTest3Page.this, Feedback.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (itemId){
                    ...
                    case R.id.questions_tab:
                        ...
                        Intent intent2= new Intent(AlcoholAddictionTest3Page.this,AlcoholAddictionQuestionsPage.class);
                        startActivity(intent2);
                        break;
                    case R.id.videos_tab:
                        System.out.println("videos");
                        Intent intent3= new Intent(AlcoholAddictionTest3Page.this,AlcoholAddictionVideosPage.class);
                        startActivity(intent3);
                        break;
                    case R.id.support_tab:
                        System.out.println("support");
                        Intent intent4= new Intent(AlcoholAddictionTest3Page.this,AlcoholAddictionSupportPage.class);
