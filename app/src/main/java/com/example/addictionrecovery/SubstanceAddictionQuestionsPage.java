...
public class SubstanceAddictionQuestionsPage extends AppCompatActivity {
    ...
    public void navBottomArrangements(){
        ...
        homeIcon.setOnClickListener(new SubstanceAddictionQuestionsPage.BottomBarListener());
        questionIcon.setOnClickListener(new SubstanceAddictionQuestionsPage.BottomBarListener());
        videoIcon.setOnClickListener(new SubstanceAddictionQuestionsPage.BottomBarListener());
        helpIcon.setOnClickListener(new SubstanceAddictionQuestionsPage.BottomBarListener());
