...
public class AlcoholAddictionShowVideos extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (itemId){
                    case R.id.home_tab:
                        ...
                        Intent intent= new Intent(AlcoholAddictionShowVideos.this,AlcoholAddictionMainPage.class);
                        startActivity(intent);
                        break;
                    case R.id.questions_tab:
                        System.out.println("questions");
                        Intent intent2= new Intent(AlcoholAddictionShowVideos.this,AlcoholAddictionQuestionsPage.class);
                        startActivity(intent2);
                        break;
                    case R.id.videos_tab:
                        System.out.println("videos");
                        Intent intent3= new Intent(AlcoholAddictionShowVideos.this,AlcoholAddictionVideosPage.class);
                        startActivity(intent3);
                        break;
                    case R.id.support_tab:
                        System.out.println("support");
                        Intent intent4= new Intent(AlcoholAddictionShowVideos.this,AlcoholAddictionSupportPage.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.kullanici_profili_option:
                        Intent intent= new Intent( AlcoholAddictionShowVideos.this,user_profile.class);
                        startActivity(intent);
                        break;
                    case R.id.neyi_amacliyoruz_option:
                        Intent intent2= new Intent( AlcoholAddictionShowVideos.this,Purpose.class);
                        startActivity(intent2);
                        break;
                    case R.id.geri_bildirim_option:
                        Intent intent3 = new Intent(AlcoholAddictionShowVideos.this, Feedback.class);
                        startActivity(intent3);
                        break;
    ...
    public void logout(){
        auth.signOut();
        Intent intent= new Intent(AlcoholAddictionShowVideos.this, LoginPage.class);
        startActivity(intent);
        finish();
    }
