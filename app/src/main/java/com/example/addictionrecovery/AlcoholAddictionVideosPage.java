...
public class AlcoholAddictionVideosPage extends AppCompatActivity {
    Toolbar tb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alcohol_addiction_videos_page);
        auth=FirebaseAuth.getInstance();
        relativeLayout=(RelativeLayout) findViewById(R.id.alcohol_addiction_videos_page_relative_layout);
    ...
    public void backButtonActivity(){
        ...
        onBackPressedDispatcher.addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(AlcoholAddictionVideosPage.this, AlcoholAddictionMainPage.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (itemId){
                    ...
                    case R.id.questions_tab:
                        ...
                        Intent intent2= new Intent(AlcoholAddictionVideosPage.this,AlcoholAddictionQuestionsPage.class);
                        startActivity(intent2);
                        break;
                    case R.id.videos_tab:
                        System.out.println("videos");
                        Intent intent3= new Intent(AlcoholAddictionVideosPage.this,AlcoholAddictionVideosPage.class);
                        startActivity(intent3);
                        break;
                    case R.id.support_tab:
                        System.out.println("support");
                        Intent intent4= new Intent(AlcoholAddictionVideosPage.this,AlcoholAddictionSupportPage.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.kullanici_profili_option:
                        Intent intent= new Intent( AlcoholAddictionVideosPage.this,user_profile.class);
                        startActivity(intent);
                        break;
                    case R.id.neyi_amacliyoruz_option:
                        Intent intent2= new Intent( AlcoholAddictionVideosPage.this,Purpose.class);
                        startActivity(intent2);
                        break;
                    case R.id.geri_bildirim_option:
                        Intent intent3 = new Intent(AlcoholAddictionVideosPage.this, Feedback.class);
                        startActivity(intent3);
                        break;
    ...
    public void logout(){
        auth.signOut();
        Intent intent= new Intent(AlcoholAddictionVideosPage.this, LoginPage.class);
        startActivity(intent);
        finish();
    }
