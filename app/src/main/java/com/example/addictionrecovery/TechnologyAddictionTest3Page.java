...
public class TechnologyAddictionTest3Page extends AppCompatActivity {
            ...
            builder.setPositiveButton("Önerilen Videoyu İzle", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (score>12 && score <=18){
                        setFinalVideo(videoTitles,videoIds,videoDescriptions,6,TechnologyAddictionTest3Page.this,TechnologyAddictionShowVideos.class);
                    }
                    else if (score>6 && score <=12){
                        setFinalVideo(videoTitles,videoIds,videoDescriptions,0,TechnologyAddictionTest3Page.this,TechnologyAddictionShowVideos.class);
                    }
                    else {
                        setFinalVideo(videoTitles,videoIds,videoDescriptions,14,TechnologyAddictionTest3Page.this,TechnologyAddictionShowVideos.class);
                    }
                }
            });
    ...
    public void backButtonActivity(){
        ...
        onBackPressedDispatcher.addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(TechnologyAddictionTest3Page.this, TechnologyAddictionMainPage.class);
    ...
    public void logout(){
        ...
        Intent intent = new Intent(TechnologyAddictionTest3Page.this, LoginPage.class);
        startActivity(intent);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.kullanici_profili_option:
                        Intent intent= new Intent(TechnologyAddictionTest3Page.this,user_profile.class);
                        startActivity(intent);
                        break;

                    case R.id.neyi_amacliyoruz_option:
                        Intent intent1=new Intent (TechnologyAddictionTest3Page.this, Purpose.class);
                        startActivity(intent1);
                        break;
                    case R.id.geri_bildirim_option:
                        Intent intent3 = new Intent(TechnologyAddictionTest3Page.this, Feedback.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (itemId){
                    ...
                    case R.id.questions_tab:
                        ...
                        Intent intent2= new Intent(TechnologyAddictionTest3Page.this,TechnologyAddictionQuestionsPage.class);
                        startActivity(intent2);
                        break;
                    case R.id.videos_tab:
                        System.out.println("videos");
                        Intent intent3= new Intent(TechnologyAddictionTest3Page.this,TechnologyAddictionVideosPage.class);
                        startActivity(intent3);
                        break;
                    case R.id.support_tab:
                        System.out.println("support");
                        Intent intent4= new Intent(TechnologyAddictionTest3Page.this,TechnologyAddictionSupportPage.class);
